 ...
 * @author pcstar
 */
public class VerificatioMethods {
    
   
/*********************************************************************************************************************/

	 boolean isNum(String chaine, int i) {
	 ...
	 String num(String chaine) {
		int i = 0;
		int token_pos = 0;
		boolean point = false;
		while (i < chaine.length()) {
			if (isNum(chaine, i)) token_pos++;
			else if(!point & chaine.charAt(token_pos)=='.') {
				token_pos++;
				point = true;
			}
			i++;
		...
		else if (token_pos == chaine.length() && point) return "Nombre reel";
		return null;
...
/*********************************************************************************************************************/
	 ...
	 boolean isChar(String chaine, int i) {
...
/*********************************************************************************************************************/
	 ...
	 String UL_reserve(String chaine) {
		
		String[] mot_reserve = {"'", "<", ">", ",", "startprogramme", "int_number", ";;", "affect", "real_number", "If", "--", "Else",
				"Start", "Get","From", "Finish", "showmes", "//.","endprogramme" };
